...
public class Entrenador {
    ...
    public String toString() {
        ...
        for(Torneo torneos: torneosEntrenadores){
            carnet+="nombre" + torneos.getNombre()+" region: "+torneos.getCodRegion();
        }
        return carnet;
    }
...
/*
    ...
    public void exportarXML(String ruta) {
        ...
        baseXML = baseXML.replaceAll("replace.idEntrenador", String.valueOf(id))
                .replaceAll("replace.fehaEXP", String.valueOf(carnet.getFechaExpedicion()))
